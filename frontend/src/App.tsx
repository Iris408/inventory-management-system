              ...
              <div className="w-full max-w-4xl">
                <div className="mb-4 max-w-2xl">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-600 xl:text-base">
                    PartsPilot brings inventory operations, stock alerts and business
                    analytics into one clear dashboard.
                  </p>
                </div>
                ...
                <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-2xl shadow-slate-300/50">
                  ...
                  <div className="mt-4 grid gap-3 lg:grid-cols-1 xl:grid-cols-[1.4fr_1fr]">
