        ...
        <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            ...
            <button
              type="button"
              disabled
              className="rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 text-sm font-semibold text-slate-400"
              title="Power BI dashboard link will be available after deployment"
            >
              Open Power BI ↗
            </button>
          </div>
